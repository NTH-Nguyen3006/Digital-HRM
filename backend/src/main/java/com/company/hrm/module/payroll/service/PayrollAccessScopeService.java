...
@Service
public class PayrollAccessScopeService {

    private final SecUserAccountRepository userAccountRepository;
    private final HrEmployeeRepository employeeRepository;

    public PayrollAccessScopeService(
    ...
    public void assertManagerCanAccessEmployee(HrEmployee targetEmployee) {
        ...
        if (principal.getRoleCode() != RoleCode.MANAGER) {
            throw new ForbiddenException("PAYROLL_MANAGER_SCOPE_REQUIRED", "Tài khoản hiện tại không thuộc vai trò quản lý.");
        }
        ...
        throw new ForbiddenException("PAYROLL_MANAGER_SCOPE_DENIED", "Bạn không có quyền xác nhận payroll của nhân sự này.");
    }
}
