...
<template>
  ...
  <div class="space-y-8 animate-fade-in">
    ...
    <!-- HEADER -->
    <PageHeader title="Duyệt Nghỉ phép" subtitle="Phê duyệt các đơn xin nghỉ của thành viên trong đội nhóm"
      :icon="CalendarOff" iconColor="bg-amber-500" iconShadow="shadow-amber-100" />

    <!-- TABS + SEARCH -->
    <div class="bg-white border border-slate-100 rounded-4xl overflow-hidden shadow-sm">
      ...
      <div class="px-8 pt-6 border-b border-slate-50 flex flex-col lg:flex-row lg:items-end justify-between gap-4">
        ...
        <div class="flex gap-2">
          <button
            ...
            :key="tab.key" @click="activeTab = tab.key" class="px-6 py-4 text-sm font-black transition-all relative"
        ...
        <div v-if="activeTab === 'pending'" class="flex items-center gap-3 pb-4">
          <div class="relative group">
            ...
            <input v-model="searchKeyword" type="text" placeholder="Tìm nhân viên..."
        ...
        <div v-if="activeTab === 'calendar'" class="flex items-center gap-2 pb-4">
          <button @click="prevMonth"
            class="w-8 h-8 rounded-xl hover:bg-slate-100 flex items-center justify-center transition-colors">
      ...
      <div class="relative min-h-[400px]">
        ...
        <div v-if="activeTab === 'pending'">
          <div v-if="filteredRequests.length > 0" class="divide-y divide-slate-50">
            <div v-for="req in filteredRequests" :key="req.leaveRequestId"
              ...
              <div class="flex items-center gap-3 justify-end min-w-[120px]">
                ...
                <template v-else>
                  <button @click="handleReview(req, 'APPROVED')" title="Phê duyệt"
                  ...
                  <button @click="handleReview(req, 'REJECTED')" title="Từ chối"
          ...
          <EmptyState v-else-if="!loading" title="Không có đơn nào chờ duyệt"
            description="Tất cả đơn xin nghỉ của đội nhóm đã được xử lý." iconName="CalendarCheck" />
        </div>

        <!-- TEAM CALENDAR VIEW -->
        <div v-if="activeTab === 'calendar'" class="p-8">
          <div v-if="groupedCalendar.length > 0" class="space-y-3">
            <div v-for="emp in groupedCalendar" :key="emp.employeeId"
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex flex-wrap gap-1">
                  <span v-for="leave in emp.leaves" :key="leave.leaveRequestId"
          ...
          <EmptyState v-else-if="!loading" title="Không có lịch phép nào"
