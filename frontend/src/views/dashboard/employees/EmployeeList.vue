...
<template>
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="relative">
            ...
            <input
              v-model="search"
              type="text"
              placeholder="Tìm bằng Tên hoặc Mã..."
          ...
          <div class="relative">
            ...
            <button
              ...
              class="flex items-center gap-2 px-4 py-2.5 bg-white border border-slate-200
            ...
            <div
              v-if="showFilter"
              class="absolute right-0 mt-2 w-64 bg-white border border-slate-200
          ...
          <!-- Add Button -->
          <button
            class="bg-indigo-600 px-5 py-2.5 rounded-xl font-bold text-white
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        >
          ...
          <input
            type="checkbox"
            class="absolute top-4 left-4 accent-indigo-500"
          ...
          <div class="flex flex-col items-center mt-2">
            <div class="w-16 h-16 rounded-full bg-indigo-100 flex items-center justify-center font-bold text-indigo-700 text-lg">
  ...
  <div
    ...
    class="fixed bottom-6 right-6 bg-white shadow-2xl border border-slate-200
