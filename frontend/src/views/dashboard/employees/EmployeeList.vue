    ...
    <div class="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
      <div>
        ...
        <div class="mt-2 flex flex-wrap items-center gap-2 text-sm font-medium text-slate-500">
          <span>
            ...
            <span class="rounded-md bg-indigo-50 px-2 py-0.5 font-bold text-indigo-700">{{ totalElements }} thành viên</span>
          </span>
          <span
            v-if="activeOrgUnitLabel"
      ...
      <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
        <div class="relative group">
          <Search class="absolute left-3.5 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400 transition-colors group-focus-within:text-indigo-500" />
          <input
            v-model="searchKeyword"
            type="text"
            placeholder="Họ tên, mã NV hoặc email..."
        ...
        <div class="relative">
          ...
          >
            ...
            <option
              v-for="item in orgUnitOptions"
              :key="item.orgUnitId"
              :value="String(item.orgUnitId)"
            >
              {{ item.orgUnitName }}
            </option>
          </select>
        ...
        <BaseButton
          ...
          size="lg"
          shadow
          class="h-12.5! rounded-2xl! px-6! font-bold"
        >
      ...
      <div v-else-if="employees.length" class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        ...
        >
          ...
          <div class="absolute right-4 top-4">
            ...
            <div
              v-if="openCardMenuId === emp.employeeId"
          ...
          <div class="flex flex-col items-center">
            ...
            <h3 class="mt-4 text-center text-lg font-bold tracking-tight text-slate-900 transition-colors group-hover:text-indigo-600">
              {{ emp.fullName }}
            </h3>
    ...
    >
      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        <BaseButton
          variant="ghost"
          size="sm"
          class="rounded-xl! px-5 text-slate-200! hover:bg-slate-800!"
          @click="clearSelected"
        >
          Bỏ chọn
        </BaseButton>
    ...
    <Teleport to="body">
      <Transition name="dialog">
        ...
        >
          ...
          <div class="relative w-full max-w-lg overflow-hidden rounded-[32px] bg-white shadow-2xl">
            ...
            <div class="space-y-5 px-6 py-6">
              <div class="space-y-2">
                ...
                <select
                  v-model="transferForm.targetOrgUnitId"
