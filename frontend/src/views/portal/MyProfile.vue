...
/* --- DỮ LIỆU MẪU CÔNG TY CONVERGED --- */
const portalProfile = ref({
  employee: {
    employeeId: 1024,
    employeeCode: 'CVG-20230501',
    fullName: 'Lê Hoàng Nam',
    workEmail: 'nam.le@converged.vn',
    workPhone: '0901 234 567',
    genderCode: 'Nam',
    dateOfBirth: '1994-08-12',
    hireDate: '2023-05-01',
    employmentStatus: 'ACTIVE',
    workLocation: 'Converged Tower - Quận 7, TP.HCM',
    taxCode: '8371928374',
    personalEmail: 'hoangnam.dev@gmail.com',
    mobilePhone: '0901 234 567',
    avatarUrl: null,
    jobTitleName: 'Senior Frontend Engineer',
    jobLevelCode: 'Level 4 (Senior)',
    orgUnitCode: 'CVG-PD',
    orgUnitName: 'Khối Phát triển Sản phẩm',
    orgUnitType: 'Department',
    managerEmployeeName: 'Nguyễn Hữu Tài (Director)',
    managerAvatar: 'https://i.pravatar.cc/150?u=tai'
  },
  profile: {
    maritalStatus: 'Đã kết hôn',
    nationality: 'Việt Nam',
    personalTaxId: '8371928374',
    healthInsurance: 'Bảo hiểm PVI Care (Gói Gold)',
    socialInsurance: 'BHXH TPHCM',
    primaryAddress: 'Chung cư Sunrise City, Phường Tân Hưng, Quận 7',
    country: 'Việt Nam',
    stateProvince: 'Hồ Chí Minh',
    city: 'Quận 7',
    postCode: '700000',
    serviceYear: '1 Năm 11 Tháng'
  },
  compensation: {
    total: 45500000,
    salary: 42000000,
...
const documents = ref([
  { id: 1, name: 'CV_LeHoangNam_Converged.pdf', category: 'Document', uploadedAt: '25/04/2023', size: '2.4 MB' },
  { id: 2, name: 'BangLuong_CVG_Thang03_2026.pdf', category: 'Payslip', uploadedAt: '05/04/2026', size: '1.1 MB' },
  { id: 3, name: 'BangLuong_CVG_Thang02_2026.pdf', category: 'Payslip', uploadedAt: '05/03/2026', size: '1.1 MB' }
])
              ...
              <table class="w-full text-left border-collapse whitespace-nowrap">
                ...
                <tbody class="text-sm text-slate-700">
                  <tr class="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4"><span class="px-2 py-1 bg-slate-100 rounded-md text-xs font-medium">Toàn thời
                        gian</span></td>
